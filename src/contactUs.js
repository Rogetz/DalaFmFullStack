            ...
            <div className="contact-us-card">
                ...
                <div className="right-side">
                    ...
                    <div className="contact-social-handles">
                        <span className="fa-brands fa-instagram"><span className="text">follow us on instagram</span></span>
                        <span className="fa-brands fa-twitter"><span className="text">follow us on twitter</span></span>
                        <span className="fa-brands fa-linkedin"><span className="text">follow us on linkedin</span></span>
                        <span className="fa-brands fa-youtube"><span className="text">follow us on youtube</span></span>
                    </div> 
